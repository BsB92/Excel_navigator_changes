...
Public Function SerializeWorkbookSnapshot(ByVal s As clsWorkbookSnapshot) As String
...
Public Function LoadWorkbookSnapshot(ByVal path As String) As clsWorkbookSnapshot
