...
Public Function CompareSnapshots(ByVal oldSnap As clsWorkbookSnapshot, ByVal newSnap As clsWorkbookSnapshot, ByVal options As clsSnapshotOptions) As clsSnapshotDiffResult
    Dim d As New clsSnapshotDiffResult
