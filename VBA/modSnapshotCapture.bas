...
Public Function CaptureWorkbookSnapshot(ByVal wb As Workbook) As clsWorkbookSnapshot
    Dim s As New clsWorkbookSnapshot
...
Private Sub CaptureVbaHashes(ByVal wb As Workbook, ByVal s As clsWorkbookSnapshot)
